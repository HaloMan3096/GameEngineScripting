...
public class HanoiTower : MonoBehaviour
{
    ...
    [SerializeField] private Transform type3Transform;
    ...
    void MoveRight()
    {
        ...
        Transform disc = popFromCurrentPeg();
    ...
    {
        if (pegNumber == 1) return type1Transform;

        if (pegNumber == 2) return type2Transform;

        return type3Transform;
    }
